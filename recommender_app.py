...
if model_selection == "Course Similarity":
    ...
    params['top_courses'] = st.sidebar.slider('Top courses',
                                    min_value=0, max_value=100,
                                    value=10, step=1)
    # Add a slide bar for choosing similarity threshold
    params['sim_threshold'] = st.sidebar.slider('Course Similarity Threshold %',
                                             min_value=1, max_value=100,
                                             value=50, step=10)
# User profile model
elif model_selection == "User Profile":
    params['top_courses'] = st.sidebar.slider('Top courses',
                                    min_value=0, max_value=100,
                                    value=10, step=1)
...
# Clustering model
    ...
    params['n_clusters'] = st.sidebar.slider('Number of Clusters',
...
elif model_selection == "Clustering with PCA":
    params['n_pca'] = st.sidebar.slider('Number of PCA Features',
...
# KNN
    ...
    params['n_neighbors'] = st.sidebar.slider('K Nearest Neighbors',
...
# KNN
    ...
    params['n_components'] = st.sidebar.slider('Number of Components',
